<div class="row">
    <div class="col-md-12">
        <div class="table-responsive">
            <table id="datatable_dikemas" class="table table-sm table-bordered datatable text-center">
                <thead>
                    <tr>
...
<script>
    $(document).ready(function() {
        $('#datatable_dikemas').DataTable({lengthChange: false, searching: true, paging: true, info: false});
    });
