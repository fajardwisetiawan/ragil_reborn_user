                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="mt-4">
                            ...
                            <input type="hidden" class="form-control" name="id_stok" id="id_stok" placeholder="ID Stok">
                            <input type="hidden" class="form-control" name="stok" id="stok" placeholder="Stok">
    ...
    $("#btnTambahKeranjang").click(function() {
        ...
        if (id_stok == null || id_stok == '') {
            ...
            if (jumlah > stok) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('transaksi/detail/add_keranjang_ready') ?>",
                    data: {
                        "id_produk": id_produk,
                        "id_stok": id_stok,
                        "jumlah": jumlah,
