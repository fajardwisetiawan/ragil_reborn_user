                ...
                <div class="modal fade myModal" id="modal_tambah">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form method="POST" action="<?= base_url("master/kategori/add") ?>" id="form_add" enctype='multipart/form-data'>
                        ...
                        <tbody>
                            ...
                            foreach ($kategori as $k) { ?>
                                <tr>
                                    <td><?= $no++ ?>.</td>
                                    <td>
                                        <button type="button" title="Edit" onclick="modal_edit('<?= $k->id ?>')" data-toggle="modal" data-target="#modal_ubah" class="btn btn-sm btn-info waves-effect waves-light" type="button"><span class="btn-label text-white"><i class="fas fa-edit"></i></span></button>
...
<div class="modal fade myModal" id="modal_ubah">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= base_url("master/kategori/update") ?>" id="form_add" enctype='multipart/form-data'>
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" name="kategori_edit" id="kategori_edit" placeholder="Kategori" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function modal_edit(id) {
        $.ajax({
            url: "<?= base_url('master/kategori/getById/') ?>" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function hapus(id) {
        swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('master/kategori/delete') ?>",
                    data: {
                        "id": id
                    },
                    dataType: "json",
